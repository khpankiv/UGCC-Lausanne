...
pageJsonFiles.forEach(pageFile => {
  ...
  languages.forEach(lang => {
    ...
    const sections = langData.sections || { hero: [], news: [], spiritual: [], community: [] };
    ...
    const html = nunjucks.render('base.njk', { ...langData, page: pageName, lang: langKey, header, footer, sections });
